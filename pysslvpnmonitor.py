...
class FortigateSSLVPN:
    ...
    def GenerateSSLVPNDic(self, content):
        ...
        for line in content:
            ...
            if printer == True:
                ...
                VPNIPAddr = line[-1].strip()
                username = line[3]
                PubIPAddr = line[-6].split("\t")[1]
                cnt = 0

                self.IP_pool.append(VPNIPAddr)
    ...
    def DisplaySSLUsers(self):
        ...
        for filename in filenamelist:
            ...
            self.SSLVPNSummary(fwname, self.total_users, self.IP_pool)
    ...
    def handle_yaml_file(self, yamlfile):
        '''
    ...
    def fetch_firewall_info(self, user, passwd):
        ...
        firewalls = self.handle_yaml_file("firewalls.yml")
    ...
    def SSHConnect(self, name, ip, port, fwvdom, user, passwd):
        '''
        Connect to Firewall and generate log file to process.
        '''
